...
import { mockJobOpenings, mockApplications } from '@/lib/mock-data'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { Button } from '@/components/ui/button'
import { Badge } from '@/components/ui/badge'
import { Briefcase, MapPin, IndianRupee, Users, Edit, Trash2 } from 'lucide-react'
      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage all your active job postings</p>
          </div>
          <Button>
                        ...
                        <div className="grid grid-cols-3 gap-2 text-center text-xs">
                          ...
                          <div className="p-2 bg-green-50 rounded">
                            <p className="font-bold text-green-800">
                              {jobApplications.filter((a) => a.status === 'shortlisted').length}
                            </p>
                            <p className="text-green-700">Short</p>
                          </div>
                          <div className="p-2 bg-blue-50 rounded">
                            <p className="font-bold text-blue-800">
                              {jobApplications.filter((a) => a.status === 'selected').length}
                            </p>
