          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between gap-4 flex-col md:flex-row">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-muted rounded-lg">
                ...
                <span className="text-foreground font-medium">{filteredStudents.length} students</span>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-foreground">Skills</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredStudents.length > 0 ? (
                    filteredStudents.map((student) => (
                      <tr key={student.id} className="border-b border-border hover:bg-muted transition-colors">
                        ...
                        <td className="py-4 px-4 text-muted-foreground">{student.branch}</td>
                        <td className="py-4 px-4">
                        ...
                        <td className="py-4 px-4 text-muted-foreground">{student.phone}</td>
                        <td className="py-4 px-4">
