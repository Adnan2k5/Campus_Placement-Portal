...
import { mockJobOpenings, mockStudents, mockApplications } from '@/lib/mock-data'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Badge } from '@/components/ui/badge'
import { Briefcase, MapPin, IndianRupee, Search, ArrowRight } from 'lucide-react'
...
export default function JobOpenings() {
  ...
  const filterJobs = (search: string, company: string) => {
    ...
    if (student) {
      filtered = filtered.filter((job) => student.cgpa >= job.eligibility.minCGPA)
    }
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-foreground text-sm mb-3">{job.description}</p>
                        ...
                        <div className="mt-4 p-3 bg-muted rounded-lg text-xs">
                          <p>
                            <strong>Eligibility:</strong> Minimum CGPA: {job.eligibility.minCGPA}{' '}
