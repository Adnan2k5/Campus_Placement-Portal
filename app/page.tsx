  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        success = signup(formData.email, formData.password, formData.name, selectedRole)
      }
      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-xs text-blue-700 mt-2 italic">Password: any value works (mock auth)</p>
          </div>
