...
export default function StudentDashboard() {
  ...
  const stats = {
    ...
    shortlisted: studentApplications.filter((a) => a.status === "shortlisted")
      .length,
  ...
  const studentNotifications = mockNotifications.filter(
    (n) => n.studentId === user?.id,
  );
      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your job applications and track your placement progress
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              View your latest job applications and their status
            </CardDescription>
          </CardHeader>
          <CardContent>
